module.exports = {
  ...
  moduleNameMapper: {
    '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': `${__dirname}/resources/tests/__mocks__/fileMock"`,
    '\\.(css|less|scss|sass)$': `${__dirname}/resources/tests/__mocks__/styleMock`,
